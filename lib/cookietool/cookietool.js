...
CookieTool.Config = (function() {
    var config = {
        'position': 'bottom',
        'message': 'Este sitio web solo usa cookies con tu consentimiento explícito. <a href="{{link}}" target="_blank">Más información</a><br/><span class="detail">El uso de cookies nos permite ofrecerte un mejor servicio, si no permites todas las cookies perderás funcionalidades, por ejemplo ver vídeos de Youtube.</span>',
        'link': '/cookies',
        'agreetext': 'Aceptar todas las cookies',
...
CookieTool.API = {
    ...
    ask: function() {
        ...
        message.innerHTML = '<p>' + CookieTool.Config.get('message').replace(/\{\{link\}\}/g, CookieTool.Config.get('link')) + '</p><button class="m-1 btn btn-outline-success" data-action="agree" onclick="">' + CookieTool.Config.get('agreetext') + '</button> <button class="m-1 btn btn-outline-danger" data-action="decline" onclick="">' + CookieTool.Config.get('declinetext') + '</button>';
