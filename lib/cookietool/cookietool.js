...
CookieTool.Config = (function() {
    var config = {
        'position': 'bottom',
        'message': 'Este sitio web solo usa cookies con tu consentimiento explícito.<br/><span class="detail">El uso de cookies nos permite ofrecerte un mejor servicio.</span>',
        'link': '/cookies',
